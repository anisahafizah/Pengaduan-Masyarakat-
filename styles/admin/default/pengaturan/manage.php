        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tickets_pengaturans">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Tampilkan pengaduan yang dikim</label>
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" value="1" name="pengaturan[display_tickets]"
                                       <?php if (set_value('pengaturan[display_tickets]', $item->display_tickets) == '1'): ?>checked="checked"<?php endif; ?>>
                                       <?php echo lang('global_yes') ?>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" value="0" name="pengaturan[display_tickets]"
                                       <?php if (set_value('pengaturan[display_tickets]', $item->display_tickets) == '0'): ?>checked="checked"<?php endif; ?>>  
