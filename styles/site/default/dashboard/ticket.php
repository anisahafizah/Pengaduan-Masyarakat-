            ...
            <?php if (config("display_tickets") == 1): ?>
                <div class="list-replies reply-form">
                    <form method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="attachement"> Lampiran</label>
            ...
            <?php if (config("display_tickets") == 1): ?>
                <div class="col-md-8 col-md-offset-2">
                    <form method="post" autocomplete="off" enctype="multipart/form-data" class="add-new-ticket">
                        ...
                        <?php endif ?>
                        <?php if (isset($success)): ?>
                            <div class="alert alert-success">pengaduan Berhasil dikirm</div>
                        <?php endif ?>

                        <div class="form-group">
                            <label for="subject">Subject Pengaduan<span class="required-field">*</span></label>
